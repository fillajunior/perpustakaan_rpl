...
<head>
    ...
    @livewireStyles
    @livewireScripts
    <link rel="icon" href="{{url('assets/img/logo2.png')}}" type="image/x-icon">
    <link rel="shortcut icon" href="{{url('assets/img/logo2.png')}}" type="image/x-icon">
    ...
    <script>
        $(document).ready(function () {
            $('#generate').click(function () {
                $('#passwordoperator').val(Math.random().toString(36).slice(-8))
            })
        })
    </script>
</body>
