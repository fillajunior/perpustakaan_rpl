...
<div class="page">
    ...
    @livewire('pengembalian-user-livewire')
    <x-footer></x-footer>
</div>
<div class="modal modal-blur fade" id="PengembalianModal" tabindex="-1" role="dialog" aria-hidden="true">
